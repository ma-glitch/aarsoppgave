...
if ($result->num_rows == 1) {
    ...
    $mail->Body = "Hei, $navn,<br><br>
            Dette er en bekreftelse på at vi har mottatt din bestilling:<br><br>
            Ordrenummer: $order_id<br>
            Dato sendt inn: " . date("Y-m-d") . "<br><br>
            Vi ønsker å forsikre deg om at vi tar din henvendelse på alvor, og vårt supportteam vil gjennomgå saken din så raskt som mulig.<br><br>
            For referanseformål, her er en kort oppsummering av din henvendelse:<br><br>
            Beskrivelse av problemet:<br><br>
            Vi vil holde deg oppdatert på statusen for saken din. Hvis du har ytterligere spørsmål eller informasjon å legge til, vennligst svar på denne e-posten eller kontakt vårt supportteam direkte.<br><br>
            Takk for din tålmodighet og forståelse.<br><br>
            Vennlig hilsen,<br>
            SKODEX AS";
